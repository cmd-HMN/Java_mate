...
abstract class Pieces {
    ...
    public abstract long white_possible_attack(long move, long empty, long black_occ);

    public abstract long black_possible_attack(long move, long empty, long white_occ);
