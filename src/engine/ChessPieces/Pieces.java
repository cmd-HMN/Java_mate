...
abstract class Pieces {
    ...
    public abstract long white_possible_attack(long move, long black_occ, long empty);

    public abstract long black_possible_attack(long move, long white_occ, long empty);
